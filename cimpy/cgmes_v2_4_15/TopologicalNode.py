...
class TopologicalNode(IdentifiedObject):
	...
	possibleProfileList = {'class': [ cgmesProfile.TP.value,cgmesProfile.SV.value, ],
						...
						#'SvVoltage': [cgmesProfile.SV.value, ],#Mohamed Invalid object instance
						'AngleRefTopologicalIsland': [cgmesProfile.SV.value, ],
						#'TopologicalIsland': [cgmesProfile.SV.value, ],#Mohamed Invalid object instance
						...
						'Terminal': [cgmesProfile.TP.value, ],#Mohamed
						 }
	...
	def __init__(self, SvInjection = None, SvVoltage = None, AngleRefTopologicalIsland = None, TopologicalIsland = None, BaseVoltage = None, ConnectivityNodes = "list", ConnectivityNodeContainer = None, ReportingGroup = None, Terminal = "list",  *args, **kw_args):
