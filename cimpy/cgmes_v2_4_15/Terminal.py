...
class Terminal(ACDCTerminal):
	...
	possibleProfileList = {'class': [cgmesProfile.DY.value, cgmesProfile.EQ.value, cgmesProfile.SV.value, cgmesProfile.SSH.value, cgmesProfile.TP.value, ],
						...
						#'SvPowerFlow': [cgmesProfile.SV.value, ],#Mohamed Object is an instance of an abstract class.
						'TopologicalNode': [cgmesProfile.TP.value, ],
						'ConnectivityNode': [cgmesProfile.EQ.value, ], #Mohamed Mandatory property missing
						 }
	...
	def __init__(self, ConductingEquipment = None, RemoteInputSignal = "list", ConverterDCSides = "list", phases = None, RegulatingControl = None, TieFlow = "list", TransformerEnd = "list", HasFirstMutualCoupling = "list", HasSecondMutualCoupling = "list", SvPowerFlow = None, TopologicalNode = None,ConnectivityNode=None,  *args, **kw_args):
